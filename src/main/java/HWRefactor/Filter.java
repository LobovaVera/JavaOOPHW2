...
public class Filter {
        public static Map<Integer, Integer> getCriteria() {
        ...
        public static void filter(Map<Integer, Integer> criteria, LinkedList<Laptop> computer) {
